...
from app.core.monitoring_deps import monitor_task, monitor_ai_call
...
def extract_text(
    ...
    with monitor_task("ocr_extraction"):
        ...
        try:
            ...
            from app.core.monitoring import record_ai_api_call
            record_ai_api_call("local_ai", ai.model, duration, len(response.choices[0].message.content or ""))
